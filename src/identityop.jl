...
const LinearRefSpaceTriangle = Union{RTRefSpace, NDRefSpace, BDMRefSpace, NCrossBDMRefSpace, RT2RefSpace, ND2RefSpace}
#const QuadraticRefSpaceTriangle = Union{LinearRefSpaceTriangle, RT2RefSpace}
defaultquadstrat(::LocalOperator, ::LinearRefSpaceTriangle, ::LinearRefSpaceTriangle) = SingleNumQStrat(10)
#defaultquadstrat(::LocalOperator, ::RT2RefSpace, ::RT2RefSpace) = SingleNumQStrat(6)
